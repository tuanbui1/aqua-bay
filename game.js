...
// loop 144 hireable auto-catching divers stock tanks while you play
(() => {
  "use strict";
  ...
  const state = {
    ...
    hiredCashier: false, cashierAcc: 0, diverLv: 0, diverAcc: 0,
  ...
  function drawTitle() {
    ...
    ctx.fillText("Aqua Bay · loop 144", W / 2, lay.stampY);
    ctx.restore();
  ...
  function drawPause() {
    ...
    if (state.mode === "help") {
      ...
      ctx.fillText("Aqua Bay · loop 144", W / 2, footY + (tall ? 28 : 20));
      ...
      ctx.fillText("Aqua Bay · loop 144", W / 2, footY + (tall ? 52 : 36));
    }
    ctx.restore();
    menuYShift = 0;
  }
