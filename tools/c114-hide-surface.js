// C114 — after a C113 DIVE FOR SEAHORSE the dash lands in
// Seahorse groves with ribbon “Point the glowing cone at a
// Seahorse” and first lock on Seahorse. The leftover: the
// fat C98 ↑ SURFACE chip already sits on the south thumb
// at bag 0/5, so a first scoop can fat-finger leave.
...
assert(/Aqua Bay · loop 114/.test(src), "title/pause stamp is loop 114");
...
console.log("c114 hide SURFACE until the hunt bags: ok (next=" + openApi.nextLockedTank() +
