// C120 — C119 pinned the ocean zone plate under TODAY
// so 70m · Seahorse groves is readable, with the cone
// ribbon parked below it. On phone 390 that is a
// three-chip stack (TODAY + 70m + “Point the glowing
// cone at a Seahorse”) and the first seahorse ! marks
// sit under it. Compact, combine, or move the cone
// ribbon — do not cover the prey. TODAY · Stock
// Seahorse and 70m · Seahorse groves stay readable.
// Plaza TODAY after unlock stays Stock Seahorse.
// Catalog stays BOOK. C119 zone plate stays. C118
// plaza TODAY stays. C117 BOOK stays. C116 ocean
// TODAY stays. C115 thumb DIVE still arms the hunt.
// C114 hide-SURFACE stays. Walk still does not buy.
// Do not auto-dive / buy / stock. Do not camera-clamp.
// Phone 390×844 first. Isolated SAVE_KEY. Turtle
// unlocked, Seahorse locked then unlocked via TAP TO
// UNLOCK, $4000. Continue.
const fs = require("fs");
...
assert(/Aqua Bay · loop 120/.test(src), "title/pause stamp is loop 120");
...
// 1) Stamp loop 120 is asserted above.
...
console.log("c120 hunt hud: ok (next=" + openApi.nextLockedTank() +
