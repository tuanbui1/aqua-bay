// C119 — C118 pinned plaza TODAY under money / BAG and
// parked the cone / catch ribbon in that next slot, so
// after thumb DIVE the 70m · Seahorse groves zone plate
// sat under “Point the glowing cone at a Seahorse”.
// TODAY must stay. The depth / zone plate must also
// stay readable (not under the ribbon). Plaza TODAY
// after unlock stays Stock Seahorse. Ocean TODAY stays
// Stock Seahorse. Catalog stays BOOK. C118 plaza TODAY
// stays. C117 BOOK stays. C116 ocean TODAY stays.
// C115 thumb DIVE still arms the hunt. C114
// hide-SURFACE stays. Walk still does not buy.
// Do not auto-dive / buy / stock. Phone 390×844 first.
...
assert(/Aqua Bay · loop 119/.test(src), "title/pause stamp is loop 119");
...
// 1) Stamp loop 119 is asserted above.
...
//    zone plate 70m · Seahorse groves readable (not under the
//    cone ribbon). Bag 0/5 no SURFACE. First lock Seahorse.
...
console.log("c119 zone plate: ok (next=" + openApi.nextLockedTank() +
