// C121 — C120 parked the cone ribbon low (or combined
// it away) so TODAY + 70m stay readable and the first
// seahorse ! marks sit below the HUD. After the first
// seahorse is bagged, that same low ribbon says
// "Nice catch! Grab more, or swim up to stock" and
// sits on the same bottom lip as wood ↑ SURFACE.
// SURFACE must own the thumb corner. The catch ribbon
// parks above SURFACE with clearance, or combines
// away — do not put it back over the grove. Bag 0/5
// still hides SURFACE (C114); that low ribbon is fine
// then. TODAY · Stock Seahorse and 70m · Seahorse
// groves stay readable. Plaza TODAY after unlock
// stays Stock Seahorse. Catalog stays BOOK. C120
// compact hunt HUD stays. C119 zone plate stays.
// C118 plaza TODAY stays. C117 BOOK stays. C116
// ocean TODAY stays. C115 thumb DIVE still arms the
// hunt. C114 hide-SURFACE stays. Walk still does not
// buy. Do not auto-dive / buy / stock / surface.
...
assert(/Aqua Bay · loop 121/.test(src), "title/pause stamp is loop 121");
...
// 1) Stamp loop 121 is asserted above.
...
console.log("c121 surface ribbon: ok (next=" + openApi.nextLockedTank() +
